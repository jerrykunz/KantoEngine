...
//#include "Kanto/Audio/AudioFileUtils.h"
//#include "Kanto/Audio/SoundBank.h"
//#include "Kanto/Audio/ResourceManager.h"
//
//#include "Kanto/Scene/Prefab.h"
//#include "Kanto/Scene/SceneSerializer.h"
//#include "Kanto/Asset/MeshColliderAsset.h"
//
//#include "Kanto/Renderer/MaterialAsset.h"
//#include "Kanto/Renderer/Mesh.h"
#include "Kanto/Renderer/Renderer.h"
#include "Kanto/Renderer/UI/Font.h"

#include "Kanto/Utilities/FileSystem.h"
//#include "Kanto/Utilities/SerializationMacros.h"
#include "Kanto/Utilities/StringUtils.h"
//#include "Kanto/Utilities/YAMLSerializationHelpers.h"

//#include "Kanto/Serialization/TextureRuntimeSerializer.h"
...
namespace Kanto {
	...
	{
		KN_CORE_WARN("TextureSerializer::DeserializeFromAssetPack");
...
//	}*/
//
//	bool FontSerializer::SerializeToAssetPack(Ref<Font> font, const std::string& path, FileStreamWriter& stream, AssetSerializationInfo& outInfo) const
//	{
//		outInfo.Offset = stream.GetStreamPosition();
//
//		//Ref<Font> font = AssetManager::GetAsset<Font>(handle);
...
//	}*/
//
//	Ref<Font> FontSerializer::DeserializeFromAssetPack(FileStreamReader& stream, const AssetPackFile::AssetInfo& assetInfo) const
//	{
//		stream.SetStreamPosition(assetInfo.PackedOffset);
//
//		std::string name;
...
//			Ref<Shader> transparentShader = Renderer::GetShaderLibrary()->Get("KantoPBR_Transparent");
//			bool transparent = materialAsset->GetMaterial()->GetShader() == transparentShader;
//			KN_SERIALIZE_PROPERTY(Transparent, transparent, out);
//
//			KN_SERIALIZE_PROPERTY(AlbedoColor, materialAsset->GetAlbedoColor(), out);
//			KN_SERIALIZE_PROPERTY(Emission, materialAsset->GetEmission(), out);
//			if (!transparent)
//			{
//				KN_SERIALIZE_PROPERTY(UseNormalMap, materialAsset->IsUsingNormalMap(), out);
//				KN_SERIALIZE_PROPERTY(Metalness, materialAsset->GetMetalness(), out);
//				KN_SERIALIZE_PROPERTY(Roughness, materialAsset->GetRoughness(), out);
//			}
//			else
//			{
//				KN_SERIALIZE_PROPERTY(Transparency, materialAsset->GetTransparency(), out);
//			}
//
//			{
...
//				KN_SERIALIZE_PROPERTY(AlbedoMap, albedoMapHandle, out);
//			}
//			if (!transparent)
//			{
//				{
...
//					KN_SERIALIZE_PROPERTY(NormalMap, normalMapHandle, out);
//				}
//				{
...
//					KN_SERIALIZE_PROPERTY(MetalnessMap, metalnessMapHandle, out);
//				}
//				{
...
//					KN_SERIALIZE_PROPERTY(RoughnessMap, roughnessMapHandle, out);
//				}
//			}
//
//			KN_SERIALIZE_PROPERTY(MaterialFlags, materialAsset->GetMaterial()->GetFlags(), out);
//
//			out << YAML::EndMap;
//		}
...
//		KN_DESERIALIZE_PROPERTY(Transparent, transparent, materialNode, false);
//
//		targetMaterialAsset = Ref<MaterialAsset>::Create(transparent);
//
//		KN_DESERIALIZE_PROPERTY(AlbedoColor, targetMaterialAsset->GetAlbedoColor(), materialNode, glm::vec3(0.8f));
//		KN_DESERIALIZE_PROPERTY(Emission, targetMaterialAsset->GetEmission(), materialNode, 0.0f);
//
//		if (!transparent)
//		{
//			targetMaterialAsset->SetUseNormalMap(materialNode["UseNormalMap"] ? materialNode["UseNormalMap"].as<bool>() : false);
//			KN_DESERIALIZE_PROPERTY(Metalness, targetMaterialAsset->GetMetalness(), materialNode, 0.0f);
//			KN_DESERIALIZE_PROPERTY(Roughness, targetMaterialAsset->GetRoughness(), materialNode, 0.5f);
//		}
//		else
//		{
//			KN_DESERIALIZE_PROPERTY(Transparency, targetMaterialAsset->GetTransparency(), materialNode, 1.0f);
//		}
//
//		AssetHandle albedoMap, normalMap, metalnessMap, roughnessMap;
//		KN_DESERIALIZE_PROPERTY(AlbedoMap, albedoMap, materialNode, (AssetHandle)0);
//		if (!transparent)
//		{
//			KN_DESERIALIZE_PROPERTY(NormalMap, normalMap, materialNode, (AssetHandle)0);
//			KN_DESERIALIZE_PROPERTY(MetalnessMap, metalnessMap, materialNode, (AssetHandle)0);
//			KN_DESERIALIZE_PROPERTY(RoughnessMap, roughnessMap, materialNode, (AssetHandle)0);
//		}
//		if (albedoMap)
//		{
...
//		}
//
//		KN_DESERIALIZE_PROPERTY(MaterialFlags, roughnessMap, materialNode, (AssetHandle)0);
...
//		{
//			KN_SERIALIZE_PROPERTY(AssetID, soundConfig->DataSourceAsset, out);
//		}
//
//		KN_SERIALIZE_PROPERTY(IsLooping, (bool)soundConfig->bLooping, out);
//		KN_SERIALIZE_PROPERTY(VolumeMultiplier, soundConfig->VolumeMultiplier, out);
//		KN_SERIALIZE_PROPERTY(PitchMultiplier, soundConfig->PitchMultiplier, out);
//		KN_SERIALIZE_PROPERTY(MasterReverbSend, soundConfig->MasterReverbSend, out);
//		KN_SERIALIZE_PROPERTY(LPFilterValue, soundConfig->LPFilterValue, out);
//		KN_SERIALIZE_PROPERTY(HPFilterValue, soundConfig->HPFilterValue, out);
//
...
//		KN_SERIALIZE_PROPERTY(Enabled, soundConfig->bSpatializationEnabled, out);
//		KN_SERIALIZE_PROPERTY(AttenuationModel, (int)spatialConfig->AttenuationMod, out);
//		KN_SERIALIZE_PROPERTY(MinGain, spatialConfig->MinGain, out);
//		KN_SERIALIZE_PROPERTY(MaxGain, spatialConfig->MaxGain, out);
//		KN_SERIALIZE_PROPERTY(MinDistance, spatialConfig->MinDistance, out);
//		KN_SERIALIZE_PROPERTY(MaxDistance, spatialConfig->MaxDistance, out);
//		KN_SERIALIZE_PROPERTY(ConeInnerAngle, spatialConfig->ConeInnerAngleInRadians, out);
//		KN_SERIALIZE_PROPERTY(ConeOuterAngle, spatialConfig->ConeOuterAngleInRadians, out);
//		KN_SERIALIZE_PROPERTY(ConeOuterGain, spatialConfig->ConeOuterGain, out);
//		KN_SERIALIZE_PROPERTY(DopplerFactor, spatialConfig->DopplerFactor, out);
//		KN_SERIALIZE_PROPERTY(Rollor, spatialConfig->Rolloff, out);
//		KN_SERIALIZE_PROPERTY(AirAbsorptionEnabled, spatialConfig->bAirAbsorptionEnabled, out);
//		KN_SERIALIZE_PROPERTY(SpreadFromSourceSize, spatialConfig->bSpreadFromSourceSize, out);
//		KN_SERIALIZE_PROPERTY(SourceSize, spatialConfig->SourceSize, out);
//		KN_SERIALIZE_PROPERTY(Spread, spatialConfig->Spread, out);
//		KN_SERIALIZE_PROPERTY(Focus, spatialConfig->Focus, out);
//
...
//				KN_CORE_VERIFY(soundBank, "SoundBank is not loaded!");
//
...
//			if (Application::IsRuntime())
//			{
//				KN_CORE_ERROR("Tried to load invalid audio source asset (UUID {0}) in SoundConfig: {1}",
...
//		}
//
//		KN_DESERIALIZE_PROPERTY(IsLooping, targetSoundConfig->bLooping, data, false);
//		KN_DESERIALIZE_PROPERTY(VolumeMultiplier, targetSoundConfig->VolumeMultiplier, data, 1.0f);
//		KN_DESERIALIZE_PROPERTY(PitchMultiplier, targetSoundConfig->PitchMultiplier, data, 1.0f);
//		KN_DESERIALIZE_PROPERTY(MasterReverbSend, targetSoundConfig->MasterReverbSend, data, 0.0f);
//		KN_DESERIALIZE_PROPERTY(LPFilterValue, targetSoundConfig->LPFilterValue, data, 20000.0f);
//		KN_DESERIALIZE_PROPERTY(HPFilterValue, targetSoundConfig->HPFilterValue, data, 0.0f);
//
...
//
//			KN_DESERIALIZE_PROPERTY(Enabled, targetSoundConfig->bSpatializationEnabled, spConfigData, false);
...
//
//			KN_DESERIALIZE_PROPERTY(MinGain, spatialConfig->MinGain, spConfigData, 0.0f);
//			KN_DESERIALIZE_PROPERTY(MaxGain, spatialConfig->MaxGain, spConfigData, 1.0f);
//			KN_DESERIALIZE_PROPERTY(MinDistance, spatialConfig->MinDistance, spConfigData, 1.0f);
//			KN_DESERIALIZE_PROPERTY(MaxDistance, spatialConfig->MaxDistance, spConfigData, 1000.0f);
//			KN_DESERIALIZE_PROPERTY(ConeInnerAngle, spatialConfig->ConeInnerAngleInRadians, spConfigData, 6.283185f);
//			KN_DESERIALIZE_PROPERTY(ConeOuterAngle, spatialConfig->ConeOuterAngleInRadians, spConfigData, 6.283185f);
//			KN_DESERIALIZE_PROPERTY(ConeOuterGain, spatialConfig->ConeOuterGain, spConfigData, 0.0f);
//			KN_DESERIALIZE_PROPERTY(DopplerFactor, spatialConfig->DopplerFactor, spConfigData, 1.0f);
//			KN_DESERIALIZE_PROPERTY(Rollor, spatialConfig->Rolloff, spConfigData, 1.0f);
//			KN_DESERIALIZE_PROPERTY(AirAbsorptionEnabled, spatialConfig->bAirAbsorptionEnabled, spConfigData, true);
//			KN_DESERIALIZE_PROPERTY(SpreadFromSourceSize, spatialConfig->bSpreadFromSourceSize, spConfigData, true);
//			KN_DESERIALIZE_PROPERTY(SourceSize, spatialConfig->SourceSize, spConfigData, 1.0f);
//			KN_DESERIALIZE_PROPERTY(Spread, spatialConfig->Spread, spConfigData, 1.0f);
//			KN_DESERIALIZE_PROPERTY(Focus, spatialConfig->Focus, spConfigData, 1.0f);
//		}
//
//		return true;
//	}
...
//	{
//		KN_CORE_VERIFY(false); // Not implemented
//		return nullptr;
//	}
//
