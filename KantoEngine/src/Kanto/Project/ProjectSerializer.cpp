...
#include "Kanto/Physics/PhysicsLayer.h"
...
namespace Kanto {
	...
	void ProjectSerializer::Serialize(const std::filesystem::path& filepath)
	{
		...
		out << YAML::Key << "Project" << YAML::Value;
		{
			...
			out << YAML::Key << "Audio" << YAML::Value;
			{
				...
				KN_SERIALIZE_PROPERTY(FileStreamingDurationThreshold, userConfig.FileStreamingDurationThreshold, out);
				out << YAML::EndMap;
			}
	...
	bool ProjectSerializer::Deserialize(const std::filesystem::path& filepath)
	{
		...
		{
			auto userConfig = MiniAudioEngine::Get().GetUserConfiguration();
			KN_DESERIALIZE_PROPERTY(FileStreamingDurationThreshold, userConfig.FileStreamingDurationThreshold, audioNode, userConfig.FileStreamingDurationThreshold);
