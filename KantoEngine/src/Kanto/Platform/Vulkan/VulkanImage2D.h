#pragma once
//
//#include "Kanto/Renderer/Image.h"
...
//		{
//			KN_CORE_ASSERT(layer < m_PerLayerImageViews.size());
...
//			case ImageFormat::DEPTH24STENCIL8:		return VulkanContext::Get()->DepthFormat; //GetCurrentDevice()->GetPhysicalDevice()->GetDepthFormat();
//			}
